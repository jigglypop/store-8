...
export const getQuestion = createAsyncThunk(QUESTION_GET, getQuestionApi);
const questionInfoExtra = createExtraGet<IQuestionRes | null>(getQuestion, QUESTION_GET);
