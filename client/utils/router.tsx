...
export function Router({ children }: IRouter) {
  ...
  return (
    <RouterContext.Provider value={{ pathname, setPathName }}>{children}</RouterContext.Provider>
  );
}
...
export function RouterSet() {
  return (
    <div>
      ...
      <DummyLink to="/product" name="product" />
      <DummyLink to="/cart" name="cart" />
      <DummyLink to="/register" name="register" />
      <DummyLink to="/github" name="github" />
      <DummyLink to="/mypage-order-list" name="mypage-order-list" />
      <DummyLink to="/mypage-refund-list" name="mypage-refund-list" />
    </div>
  );
}
